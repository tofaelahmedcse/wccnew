        ...
        <main id="main" class="site-main" role="main">
                    ...
                    <section class="equal-section position-relative commitment-info" data-mh="custom-loc-2">
                        ...
                        <div class="container">
                            <div class="row py-5">
                                ...
                                <div class="col-sm-12 col-md-6 img-holder col-xs-12"
            ...
            <section class="b-block organized-info">
                <div class="container">
                    ...
                    <div class="row justify-content-center mt-5 organized-row">
                        <div class="col-12 col-lg-8 text-center organized-col">
            ...
            <section class="b-block world-skill">
                <div class="container">
                    ...
                    <div class="row mt-5 align-items-center world-skill-row">
